...
public class SecurityConfig {
    ...
    private static final List<String> DEFAULT_PERMIT_METHODS = List.of(GET.name(), HEAD.name(), POST.name(), PATCH.name(), DELETE.name());
     ...
     * <p>상용 SecurityFilterChain과 다른 점</p>
     * <li>HTTPS를 요구하지 않음</li>
     * <li>localhost의 모든 요청을 허용</li>
     */
    @Bean
    @Profile("dev")
    ...
    /**
     * localhost의 요청만 허용하는 AuthorizationManager
     * <br>
     * <li>Actuator, Prometheus 등 Monitoring을 위한 Endpoint에 대한 접근 제어 등에 사용</li>
     */
