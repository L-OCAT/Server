...
public class FoundItemRepositoryImpl implements FoundItemRepository {
  ...
  public FoundItemRepositoryImpl(DynamoDbEnhancedClient dbEnhancedClient) {
    this.foundDynamoDbTable = dbEnhancedClient.table("FOUND_ITEM", TableSchema.fromBean(FoundItem.class));
  }

  @Override
  public FoundItem save(FoundItem entity) {
    PutItemEnhancedRequest<FoundItem> request = PutItemEnhancedRequest.builder(FoundItem.class)
      .item(entity)
      .build();
  ...
  public List<FoundItem> findAll() {
    return this.foundDynamoDbTable.scan(r -> r.limit(50))
      .items()
      .stream()
      .toList();
  }
  ...
  public FoundItem update(FoundItem entity) {
    UpdateItemEnhancedRequest<FoundItem> request = UpdateItemEnhancedRequest.builder(FoundItem.class)
      .item(entity)
      .build();
