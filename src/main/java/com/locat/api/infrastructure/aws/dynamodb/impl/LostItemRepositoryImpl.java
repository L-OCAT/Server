...
public class LostItemRepositoryImpl implements LostItemRepository {
  ...
  public LostItemRepositoryImpl(DynamoDbEnhancedClient dbEnhancedClient) {
    this.lostDynamoDbTable = dbEnhancedClient.table("LOST_ITEM", TableSchema.fromBean(LostItem.class));
  }

  @Override
  public LostItem save(LostItem entity) {
    PutItemEnhancedRequest<LostItem> request = PutItemEnhancedRequest.builder(LostItem.class)
      .item(entity)
      .build();
  ...
  public List<LostItem> findAll() {
    return this.lostDynamoDbTable.scan(r -> r.limit(50))
      .items()
      .stream()
      .toList();
  }
  ...
  public LostItem update(LostItem entity) {
    UpdateItemEnhancedRequest<LostItem> request = UpdateItemEnhancedRequest.builder(LostItem.class)
      .item(entity)
      .build();
